var dayPatients = [
    { id: 101, name: 'María García López',  dob: '1958-03-14', age: 67, gender: 'Female', scheduledTime: '08:00', arrivalTime: '07:45', chair: 'C01',   pathwayType: 'Chemo',            phaseStatus: 'Infusing',          estimatedDurationMin: 180, elapsedMin: 95,  remainingMin: 85,  alerts: ['Allergy: Penicillin', 'High-Risk Meds', 'Fall Risk'], flags: ['high-risk-meds'],             assignedNurse: 'Ana Ruiz',     orderingProvider: 'Dr. Fernández', department: 'Oncology' },
    { id: 102, name: 'Carlos Martínez Ruiz', dob: '1970-07-22', age: 55, gender: 'Male',   scheduledTime: '08:30', arrivalTime: '08:20', chair: 'C02',   pathwayType: 'Iron Infusion',    phaseStatus: 'Observation',       estimatedDurationMin: 120, elapsedMin: 110, remainingMin: 10,  alerts: [],                                                      flags: [],                             assignedNurse: 'Laura Sánchez', orderingProvider: 'Dr. López',     department: 'Internal Medicine' },
    ...
    { id: 108, name: 'Miguel Ángel Soto',    dob: '1948-04-07', age: 77, gender: 'Male',   scheduledTime: '07:30', arrivalTime: '07:25', chair: 'Bay 2', pathwayType: 'Transfusion',      phaseStatus: 'Ready for Discharge', estimatedDurationMin: 120, elapsedMin: 120, remainingMin: 0,   alerts: ['DNR', 'Fall Risk'],                                    flags: [],                             assignedNurse: 'Ana Ruiz',     orderingProvider: 'Dr. López',     department: 'Hematology' },
    { id: 109, name: 'Isabel Romero Castro', dob: '1966-08-16', age: 59, gender: 'Female', scheduledTime: '10:30', arrivalTime: null,    chair: 'C07',   pathwayType: 'Iron Infusion',    phaseStatus: 'Scheduled',         estimatedDurationMin: 90,  elapsedMin: 0,   remainingMin: 90,  alerts: [],                                                      flags: [],                             assignedNurse: 'Laura Sánchez', orderingProvider: 'Dr. Moreno',   department: 'Internal Medicine' },
    { id: 110, name: 'Pablo Jiménez Reyes',  dob: '1982-02-28', age: 44, gender: 'Male',   scheduledTime: '08:00', arrivalTime: '07:50', chair: 'C08',   pathwayType: 'Chemo',            phaseStatus: 'Completed',         estimatedDurationMin: 180, elapsedMin: 180, remainingMin: 0,   alerts: ['High-Risk Meds'],                                      flags: ['high-risk-meds'],             assignedNurse: 'Carmen Vidal', orderingProvider: 'Dr. Fernández', department: 'Oncology' },
    { id: 111, name: 'Rosa María Delgado',   dob: '1973-06-09', age: 52, gender: 'Female', scheduledTime: '11:00', arrivalTime: null,    chair: 'C09',   pathwayType: 'Chemo',            phaseStatus: 'Scheduled',         estimatedDurationMin: 240, elapsedMin: 0,   remainingMin: 240, alerts: ['Allergy: Iodine'],                                      flags: [],                             assignedNurse: 'Pedro Gómez',  orderingProvider: 'Dr. Navarro',   department: 'Oncology' },
    { id: 112, name: 'Andrés Vargas Pinto',  dob: '1951-10-05', age: 74, gender: 'Male',   scheduledTime: '07:00', arrivalTime: '06:55', chair: 'Bay 3', pathwayType: 'Transfusion',      phaseStatus: 'Completed',         estimatedDurationMin: 150, elapsedMin: 150, remainingMin: 0,   alerts: ['Fall Risk', 'Isolation', 'Allergy: NSAIDs', 'Seizure Risk'], flags: ['isolation'],              assignedNurse: 'Ana Ruiz',     orderingProvider: 'Dr. López',     department: 'Hematology' },
    { id: 113, name: 'Sofía Medina Ortiz',   dob: '1995-04-18', age: 30, gender: 'Female', scheduledTime: '09:30', arrivalTime: '09:30', chair: 'C10',   pathwayType: 'Biologic Infusion', phaseStatus: 'Infusing',          estimatedDurationMin: 120, elapsedMin: 45,  remainingMin: 75,  alerts: [],                                                      flags: [],                             assignedNurse: 'Carmen Vidal', orderingProvider: 'Dr. Navarro',   department: 'Rheumatology' },
    { id: 114, name: 'Ramón Flores Aguilar', dob: '1960-12-01', age: 65, gender: 'Male',   scheduledTime: '08:30', arrivalTime: null,    chair: 'C11',   pathwayType: 'Iron Infusion',    phaseStatus: 'No-show',           estimatedDurationMin: 90,  elapsedMin: 0,   remainingMin: 0,   alerts: [],                                                      flags: [],                             assignedNurse: 'Laura Sánchez', orderingProvider: 'Dr. Moreno',   department: 'Internal Medicine' }
];
...
function updateDayTabCounts() {
    var all = dayPatients;
    var counts = {
        'loc-all':       all.length,
        'loc-recent':    all.filter(function(p) { return p.arrivalTime !== null; }).length,
        'loc-discharge': all.filter(function(p) { return p.phaseStatus === 'Ready for Discharge'; }).length,
        'loc-icu':       all.filter(function(p) { return p.phaseStatus === 'Observation'; }).length,
        'loc-surgery':   0
    };
