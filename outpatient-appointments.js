var opAppointments = [
    { id: 201, name: 'María García López',      dob: '1958-03-14', age: 67, gender: 'Female', mrn: '46283', scheduledTime: '08:30', visitType: 'Follow-up',           reason: 'Hypertension review',      status: 'Completed',       waitMinutes: 0,  delayMinutes: 0,  alerts: ['Allergy: Penicillin', 'High-Risk Meds'],  doctor: 'Dr. Rory Rogers',  room: 'Room 2',           department: 'Cardiology'       },
    { id: 202, name: 'Carlos Martínez Ruiz',    dob: '1970-07-22', age: 55, gender: 'Male',   mrn: '31874', scheduledTime: '09:00', visitType: 'New Patient',          reason: 'Chest pain evaluation',    status: 'Completed',       waitMinutes: 0,  delayMinutes: 0,  alerts: [],                                          doctor: 'Dr. Fernández',    room: 'Room 1',           department: 'Cardiology'       },
    { id: 203, name: 'Elena Rodríguez Díaz',    dob: '1985-11-03', age: 40, gender: 'Female', mrn: '52910', scheduledTime: '09:00', visitType: 'Specialist Referral',  reason: 'Joint inflammation',       status: 'Completed',       waitMinutes: 0,  delayMinutes: 5,  alerts: ['Allergy: Sulfa'],                          doctor: 'Dr. López',        room: 'Room 3',           department: 'Rheumatology'     },
    { id: 204, name: 'José Antonio Pérez',      dob: '1962-01-19', age: 64, gender: 'Male',   mrn: '18453', scheduledTime: '09:30', visitType: 'Follow-up',           reason: 'Diabetes management',     status: 'Completed',       waitMinutes: 0,  delayMinutes: 0,  alerts: ['High-Risk Meds', 'Fall Risk'],             doctor: 'Dr. Moreno',       room: 'Room 4',           department: 'Internal Medicine'},
    { id: 205, name: 'Lucía Hernández Gil',     dob: '1990-05-30', age: 35, gender: 'Female', mrn: '67021', scheduledTime: '09:30', visitType: 'Annual Check-up',     reason: 'Routine health review',    status: 'Completed',       waitMinutes: 0,  delayMinutes: 0,  alerts: [],                                          doctor: 'Dr. Rory Rogers',  room: 'Room 2',           department: 'Cardiology'       },
    { id: 206, name: 'Fernando Muñoz Vega',     dob: '1955-09-11', age: 70, gender: 'Male',   mrn: '29384', scheduledTime: '10:00', visitType: 'Post-op',             reason: 'Post-op knee review',     status: 'Completed',       waitMinutes: 0,  delayMinutes: 0,  alerts: ['Fall Risk', 'Pacemaker'],                  doctor: 'Dr. Navarro',      room: 'Consulting Room A', department: 'Oncology'         },
    { id: 207, name: 'Ana Belén Torres',        dob: '1978-12-25', age: 47, gender: 'Female', mrn: '74562', scheduledTime: '10:00', visitType: 'Follow-up',           reason: 'Thyroid levels check',    status: 'Completed',       waitMinutes: 0,  delayMinutes: 8,  alerts: [],                                          doctor: 'Dr. López',        room: 'Room 1',           department: 'Internal Medicine'},
    { id: 208, name: 'Miguel Ángel Soto',       dob: '1948-04-07', age: 77, gender: 'Male',   mrn: '38291', scheduledTime: '10:30', visitType: 'Specialist Referral', reason: 'Haematology review',      status: 'Completed',       waitMinutes: 0,  delayMinutes: 0,  alerts: ['DNR', 'Fall Risk'],                        doctor: 'Dr. Fernández',    room: 'Room 3',           department: 'Hematology'       },
    { id: 209, name: 'Isabel Romero Castro',    dob: '1966-08-16', age: 59, gender: 'Female', mrn: '91047', scheduledTime: '11:00', visitType: 'Review',              reason: 'Anaemia management',      status: 'In Consultation', waitMinutes: 8,  delayMinutes: 0,  alerts: ['Allergy: Iodine'],                         doctor: 'Dr. Rory Rogers',  room: 'Room 2',           department: 'Cardiology'       },
    { id: 210, name: 'Pablo Jiménez Reyes',     dob: '1982-02-28', age: 44, gender: 'Male',   mrn: '55673', scheduledTime: '11:00', visitType: 'Follow-up',           reason: 'Asthma control',          status: 'In Consultation', waitMinutes: 12, delayMinutes: 0,  alerts: ['High-Risk Meds'],                          doctor: 'Dr. Moreno',       room: 'Room 4',           department: 'Internal Medicine'},
    { id: 211, name: 'Rosa María Delgado',      dob: '1973-06-09', age: 52, gender: 'Female', mrn: '43802', scheduledTime: '11:30', visitType: 'New Patient',         reason: 'Referred for oncology',   status: 'Waiting',         waitMinutes: 14, delayMinutes: 0,  alerts: ['Allergy: Contrast', 'Neutropenia'],        doctor: 'Dr. Navarro',      room: 'Consulting Room B', department: 'Oncology'         },
    { id: 212, name: 'Andrés Vargas Pinto',     dob: '1951-10-05', age: 74, gender: 'Male',   mrn: '82736', scheduledTime: '11:30', visitType: 'Annual Check-up',     reason: 'Cardiovascular check',    status: 'Waiting',         waitMinutes: 7,  delayMinutes: 5,  alerts: ['Fall Risk', 'Isolation'],                  doctor: 'Dr. Rory Rogers',  room: 'Room 2',           department: 'Cardiology'       },
    { id: 213, name: 'Sofía Medina Ortiz',      dob: '1995-04-18', age: 30, gender: 'Female', mrn: '16254', scheduledTime: '12:00', visitType: 'Follow-up',           reason: 'Rheumatoid arthritis',    status: 'Waiting',         waitMinutes: 3,  delayMinutes: 0,  alerts: [],                                          doctor: 'Dr. López',        room: 'Room 3',           department: 'Rheumatology'     },
    { id: 214, name: 'Ramón Flores Aguilar',    dob: '1960-12-01', age: 65, gender: 'Male',   mrn: '60918', scheduledTime: '12:00', visitType: 'Post-op',             reason: 'Post-surgery follow-up',  status: 'Waiting',         waitMinutes: 21, delayMinutes: 10, alerts: ['Allergy: NSAIDs', 'Seizure Risk'],          doctor: 'Dr. Navarro',      room: 'Consulting Room C', department: 'Oncology'         },
    { id: 215, name: 'Laura Castillo Vidal',    dob: '1988-09-02', age: 37, gender: 'Female', mrn: '30571', scheduledTime: '12:30', visitType: 'Specialist Referral', reason: 'Persistent migraines',    status: 'Waiting',         waitMinutes: 5,  delayMinutes: 0,  alerts: [],                                          doctor: 'Dr. Fernández',    room: 'Room 1',           department: 'Hematology'       },
    { id: 216, name: 'Diego Molina Reyes',      dob: '1975-03-17', age: 51, gender: 'Male',   mrn: '77430', scheduledTime: '13:00', visitType: 'Follow-up',           reason: 'Hypertension review',     status: 'Arrived',         waitMinutes: 0,  delayMinutes: 0,  alerts: [],                                          doctor: 'Dr. Rory Rogers',  room: 'Room 2',           department: 'Cardiology'       },
    { id: 217, name: 'Carmen Herrera Blanco',   dob: '1952-07-28', age: 73, gender: 'Female', mrn: '19843', scheduledTime: '13:00', visitType: 'Review',              reason: 'Lipid panel results',     status: 'Arrived',         waitMinutes: 0,  delayMinutes: 0,  alerts: ['Fall Risk'],                               doctor: 'Dr. López',        room: 'Room 3',           department: 'Internal Medicine'},
    { id: 218, name: 'Javier Ortega Santos',    dob: '1967-11-14', age: 58, gender: 'Male',   mrn: '48205', scheduledTime: '13:30', visitType: 'Annual Check-up',     reason: 'Diabetes annual review',  status: 'Arrived',         waitMinutes: 0,  delayMinutes: 0,  alerts: ['High-Risk Meds', 'Allergy: Penicillin'],   doctor: 'Dr. Moreno',       room: 'Room 4',           department: 'Internal Medicine'}
];
...
function formatOpWaitDelay(appt) {
    ...
    if (appt.delayMinutes > 0) {
        return '<span class="op-delay-badge">' + appt.delayMinutes + ' min late</span>';
    }
    if (appt.waitMinutes > 0) {
        return '<span class="op-wait-text">' + appt.waitMinutes + ' min waiting</span>';
    }
...
function renderOpList() {
    ...
    appts.forEach(function (appt) {
        ...
        var hasDelay = appt.delayMinutes > 0;
