...
var MockClinicalData = {
    ...
    patientClinicalContext: {
        46: {
            ...
            documents: [
                { id: 1, name: 'TTO_INP_CARD_Dr.Rory Rogers', author: 'Dr.Rory Rogers', department: 'Cardiology', type: 'TTO Report', date: '25/09/2025 13:02', status: 'signed', accessWeb: true, category: 'reports' },
                { id: 2, name: 'Doctor Transfer Out of Hospital', author: 'Dr.Rory Rogers', department: 'Cardiology', type: 'Medical Report', date: '16/09/2025 14:13', status: 'draft', accessWeb: false, category: 'reports' },
                { id: 3, name: 'DISCHARGE_EMR_EMER_Dr.Rory Rogers', author: 'Dr.Rory Rogers', department: 'Adult Emergency', type: 'Discharge Report', date: '23/09/2024 14:07', status: 'signed', accessWeb: true, category: 'reports' },
                { id: 4, name: 'Informed Consent Surgery_Dr.Martinez', author: 'Dr.Ana Martinez', department: 'General Surgery', type: 'Consent Form', date: '10/01/2026 09:30', status: 'signed', accessWeb: true, category: 'informed-consent' },
                { id: 5, name: 'Consent_Anesthesia_Regional', author: 'Dr.James Wilson', department: 'Anesthesiology', type: 'Consent Form', date: '10/01/2026 08:45', status: 'signed', accessWeb: false, category: 'informed-consent' },
                { id: 6, name: 'Lab_Results_CBC_Panel', author: 'Lab Technician', department: 'Laboratory', type: 'Lab Report', date: '18/02/2026 10:20', status: 'signed', accessWeb: true, category: 'various' },
                { id: 7, name: 'Digital_History_Cardiology_2025', author: 'Dr.Rory Rogers', department: 'Cardiology', type: 'Clinical History', date: '01/02/2026 11:00', status: 'draft', accessWeb: false, category: 'digital-history' },
                { id: 8, name: 'Nursing_Assessment_Initial', author: 'Nurse Sarah Thompson', department: 'Adult Emergency', type: 'Nursing Report', date: '15/02/2026 16:45', status: 'signed', accessWeb: true, category: 'various' }
            ],
